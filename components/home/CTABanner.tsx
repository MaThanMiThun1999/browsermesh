...
export default function CTABanner() {
    return (
        <section className="max-w-7xl mx-auto px-6 py-12 relative">
            <div
                className="rounded-[24px] p-8 lg:px-12 lg:py-10 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 border border-white/50 relative overflow-hidden backdrop-blur-xl"
                style={{
                    background:
                        "linear-gradient(90deg, rgba(20, 10, 45, 0.65) 0%, rgba(8, 4, 20, 0.8) 100%)",
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-8 text-center md:text-left w-full md:w-auto">
                    ...
                    <div className="flex flex-col justify-center pt-1">
                        <h2 className="text-[26px] font-bold text-white mb-1.5 tracking-tight">
                            Ready to bypass the bots?
                        </h2>
                        <p className="text-slate-300 text-[14px] leading-relaxed max-w-[420px]">
                            Join thousands of professional using {siteInfo.name} for unlimited,
