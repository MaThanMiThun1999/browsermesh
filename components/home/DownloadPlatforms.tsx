        ...
        <section className="max-w-7xl mx-auto px-6 py-16 relative">
            <div className="glass-framer rounded-[24px] p-10 lg:p-14 relative overflow-hidden flex flex-col lg:flex-row items-center gap-8 lg:gap-12 bg-[#05050f] border border-white/5 shadow-[0_0_50px_rgba(0,0,0,0.8)]">
                ...
                <div className="absolute inset-0 z-0 pointer-events-none">
                    <svg viewBox="0 0 1000 600" className="absolute top-0 left-0 w-full h-full object-cover opacity-80" preserveAspectRatio="xMidYMid slice">
                        {/* Huge intersecting orbit arc */}
                        <circle cx="800" cy="0" r="450" fill="none" stroke="url(#arcGradient1)" strokeWidth="1.5" className="drop-shadow-[0_0_20px_rgba(99,102,241,0.6)]" />
                        <circle cx="900" cy="100" r="500" fill="none" stroke="url(#arcGradient2)" strokeWidth="0.5" className="drop-shadow-[0_0_10px_rgba(168,85,247,0.3)]" />
                ...
                <div className="lg:w-[35%] shrink-0 flex flex-col items-start relative z-10 pl-2 lg:pl-6">
                    ...
                    <p className="text-slate-400/90 text-[14px] leading-relaxed mb-10 max-w-[360px]">
                        Run BrowserMesh on any device you prefer. Your settings, jobs, and data stay in sync.
                    </p>
                    ...
                    <ul className="space-y-4 mb-12">
                        {[
                            ...
                            <li key={i} className="flex items-center gap-3.5">
                                ...
                                <span className="text-slate-300 text-[13px] font-medium tracking-wide">{item}</span>
                            </li>
                        ))}
                    </ul>
                    ...
                    <div className="flex gap-3">
                        {[
                            ...
                            <button key={i} className="w-14 h-14 rounded-2xl bg-black/40 border border-white/5 hover:bg-white/[0.04] hover:border-white/20 transition-all flex items-center justify-center shadow-lg group relative overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-b from-white/[0.02] to-transparent pointer-events-none" />
                                <span className={`${platform.color} group-hover:scale-110 transition-transform duration-300 relative z-10 drop-shadow-md`}>
                                    {platform.icon}
                                </span>
                            </button>
                        ))}
