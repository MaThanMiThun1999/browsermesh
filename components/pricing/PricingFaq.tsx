...
export default function PricingFaq() {
    ...
    const faqs = [
        {
            id: 0,
            question: "What is the difference between BrowserMesh and traditional Proxy APIs?",
            answer: "Traditional proxy APIs route headless traffic through data centers, which are easily detected by modern anti-bots. BrowserMesh utilizes a decentralized network of real, stateful residential browser nodes running natively on Windows, Linux, and macOS, completely bypassing fingerprint detection.",
        ...
        },
        {
            ...
            answer: "The Free plan allows you to run the local desktop/headless node on 1 device. Pro lets you connect up to 3 devices to your account simultaneously for parallel scraping.",
        ...
        },
        {
            ...
            answer: "The Free plan includes 500 monthly results, 1 active device node, free marketplace plugins, and JSON exports. The Pro plan ($29/mo) unlocks 10,000 monthly results, 3 active devices, Pro/Premium plugins, automated scheduled jobs, 2 GB cloud storage, and CSV/XLSX exports.",
            icon: <Layers className="w-5 h-5 text-cyan-400" />,
            bgColor: "bg-cyan-500/10 border-cyan-500/20",
        },
        {
            id: 5,
            question: "Do I need to purchase third-party proxies?",
            answer: "No. BrowserMesh is designed to execute tasks through your connected residential nodes using their authentic ISP connections. You don't need to pay extortionate per-gigabyte proxy bills.",
